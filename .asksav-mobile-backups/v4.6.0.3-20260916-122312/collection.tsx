...
export default function CollectionScreen(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  <View style={s.brandRow}><View style={s.logo}><Text style={s.logoText}>SAV</Text></View><View><Text style={s.brand}>My Collection</Text><Text style={s.brandSub}>Understand what your saved items may be worth</Text>
   <View style={s.syncRow}><Ionicons name={syncState==="synced"?"cloud-done-outline":syncState==="offline"?"cloud-offline-outline":syncState==="syncing"?"sync-outline":"phone-portrait-outline"} size={13} color="#66858d"/><Text style={s.syncText}>{syncState==="synced"?"Synced to your AskSAV account":syncState==="offline"?"Offline - saved on this device":syncState==="syncing"?"Syncing Collection...":"Saved on this device - sign in to sync"}</Text></View>
  </View></View>
  ...
  <Text style={s.note}>Signed-in Collections sync to your AskSAV account. A local copy remains available on this device.</Text>
