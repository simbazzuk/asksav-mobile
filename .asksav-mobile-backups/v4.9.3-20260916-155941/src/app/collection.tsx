  ...
  {items.length===0?<View style={s.empty}>
   ...
   return <TouchableOpacity key={item.id} style={s.card} activeOpacity={0.82} onPress={()=>router.push({pathname:"/collection-detail",params:{id:item.id}})}>
    ...
    <View style={s.cardTop}>
     {item.imageUri?<Image source={{uri:item.imageUri}} style={s.image}/>:<View style={[s.image,s.placeholder]}><Ionicons name="image-outline" size={28} color={DynamicColorIOS({light:"#789097",dark:"#e0eeee"})}/></View>}
     <View style={s.body}>
