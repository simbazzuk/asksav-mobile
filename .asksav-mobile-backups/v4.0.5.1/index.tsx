// AskSAV Mobile v4.0.5
import { useEffect, useState } from "react";
import {ActivityIndicator, Alert, Image, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View, ImageBackground} from "react-native";
...
export default function HomeScreen() {
  ...
  useEffect(()=>{
    const timer=setTimeout(()=>setShowLaunchSplash(false),2400);
  ...
  if (imageUri) {
    if(showLaunchSplash){
    return <View style={{flex:1,backgroundColor:"#f7fbff"}}>
      <ImageBackground
        source={require("../../assets/asksav/blue-launch.png")}
        resizeMode="contain"
        style={{flex:1,width:"100%",backgroundColor:"#f7fbff"}}
      />
    </View>;
  }
      ...
      <SafeAreaView style={s.safe}>
        <ScrollView contentContainerStyle={s.previewPage}>
          ...
          <TouchableOpacity style={s.primary} onPress={usePhoto} disabled={analysing}>
            ...
            <TouchableOpacity style={s.primary} onPress={()=>{setImageUri(null);setAnalysis(null);setMarketData(null);setMarketError(null);}}>
