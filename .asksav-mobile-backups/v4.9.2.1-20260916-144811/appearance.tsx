...
const s=StyleSheet.create({
 safe:{flex:1,backgroundColor:"#f4fbf9"},safeDark:{backgroundColor:"#07191d"},page:{padding:22},
 back:{flexDirection:"row",alignItems:"center",gap:3,marginTop:8,marginBottom:22},backText:{color:"#087f72",fontWeight:"800"},
 title:{color:"#062f4f",fontSize:36,fontWeight:"900"},copy:{color:"#66858d",fontSize:14,marginTop:5,marginBottom:22},
 card:{backgroundColor:"#fff",borderWidth:1,borderColor:"#cfe8e2",borderRadius:20,overflow:"hidden"},cardDark:{backgroundColor:"#10282d",borderColor:"#24464c"},
 option:{minHeight:78,flexDirection:"row",alignItems:"center",gap:12,paddingHorizontal:16},border:{borderTopWidth:1,borderTopColor:"#edf4f2"},borderDark:{borderTopColor:"#24464c"},
 icon:{width:42,height:42,borderRadius:13,backgroundColor:"#e8f7f4",alignItems:"center",justifyContent:"center"},iconDark:{backgroundColor:"#17383d"},
 label:{color:"#062f4f",fontSize:16,fontWeight:"900"},optionCopy:{color:"#66858d",fontSize:11,marginTop:3},circle:{width:22,height:22,borderRadius:11,borderWidth:2,borderColor:"#a9c3c5"},
 note:{color:"#789097",fontSize:11,lineHeight:17,textAlign:"center",marginTop:18},textLight:{color:"#eefbf8"},mutedDark:{color:"#9db7b9"}
});
