...
export default function RootLayout() {
  ...
  useEffect(()=>{initialiseAskSAVAppearance();},[]);
  return (
    <Tabs initialRouteName="index" backBehavior="history" screenOptions={{headerShown:false,tabBarActiveTintColor:"#0aaf86",tabBarInactiveTintColor:dark?"#8ca7aa":"#78909c",tabBarStyle:{height:78,paddingTop:8,paddingBottom:12,borderTopColor:dark?"#24464c":"#dce9e7",backgroundColor:dark?"#0b2025":"#fff"},tabBarLabelStyle:{fontSize:12,fontWeight:"700"}}}>
