...
const s=StyleSheet.create({
 ...
 appearanceButton:{backgroundColor:"#fff",borderWidth:1.5,borderColor:"#8fd4c8",borderRadius:18,padding:14,marginBottom:12,flexDirection:"row",alignItems:"center",gap:11},
