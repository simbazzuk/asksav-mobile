...
export default function CollectionScreen(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  ...
  <View style={s.disclaimer}><Ionicons name="information-circle-outline" size={16} color="#66858d"/><Text style={s.disclaimerText}>Collection values are indicative Market Intelligence, not formal valuations or guaranteed sale prices.</Text></View>
...
const s=StyleSheet.create({
 ...
 brandRow:{flexDirection:"row",alignItems:"center",gap:11},syncRow:{flexDirection:"row",alignItems:"center",gap:4,marginTop:4},syncText:{color:"#66858d",fontSize:9,fontWeight:"700"},logo:{width:48,height:48,borderRadius:15,backgroundColor:"#13b8aa",alignItems:"center",justifyContent:"center"},logoText:{color:"#fff",fontWeight:"900",fontSize:16},brand:{color:"#082f49",fontSize:24,fontWeight:"900"},brandSub:{color:"#66858d",fontSize:11},
 collectionTools:{marginTop:20,marginBottom:4},searchBox:{minHeight:48,borderRadius:15,borderWidth:1,borderColor:"#cfe8e2",backgroundColor:"#fff",paddingHorizontal:13,flexDirection:"row",alignItems:"center",gap:8},searchInput:{flex:1,color:"#173f51",fontSize:14,paddingVertical:10},filterRow:{gap:7,paddingVertical:10},filterChip:{borderRadius:99,borderWidth:1,borderColor:"#cfe8e2",backgroundColor:"#fff",paddingHorizontal:12,paddingVertical:7},filterChipActive:{backgroundColor:"#087f72",borderColor:"#087f72"},filterChipText:{color:"#557681",fontSize:11,fontWeight:"800"},filterChipTextActive:{color:"#fff"},sortRow:{flexDirection:"row",alignItems:"center",gap:8},sortLabel:{color:"#789097",fontSize:9,fontWeight:"900",letterSpacing:.7},sortChoices:{gap:6},sortChip:{borderRadius:10,backgroundColor:"#eef6f4",paddingHorizontal:9,paddingVertical:6},sortChipActive:{backgroundColor:"#d8f1eb"},sortChipText:{color:"#66858d",fontSize:10,fontWeight:"800"},sortChipTextActive:{color:"#087f72"},resultCount:{color:"#789097",fontSize:10,fontWeight:"700",marginTop:9},clearFilters:{marginTop:14,paddingHorizontal:15,paddingVertical:10,borderRadius:12,backgroundColor:"#e8f7f4"},clearFiltersText:{color:"#087f72",fontSize:11,fontWeight:"900"},
 valueDashboard:{backgroundColor:"#e8f7f4",borderWidth:1,borderColor:"#b9ddd5",borderRadius:22,padding:19,marginTop:24,marginBottom:14},dashboardEyebrow:{color:"#087f72",fontSize:10,fontWeight:"900",letterSpacing:.8},dashboardValue:{color:"#062f4f",fontSize:36,fontWeight:"900",marginTop:4},dashboardNote:{color:"#5f7c86",fontSize:11,lineHeight:16,marginTop:4},statsRow:{flexDirection:"row",gap:8,marginTop:16},stat:{flex:1,backgroundColor:"rgba(255,255,255,0.72)",borderRadius:13,paddingVertical:10,alignItems:"center"},statValue:{color:"#062f4f",fontSize:18,fontWeight:"900"},statLabel:{color:"#66858d",fontSize:10,fontWeight:"800",marginTop:2},
 card:{backgroundColor:"#fff",borderWidth:1,borderColor:"#d9ebe7",borderRadius:18,padding:12,marginBottom:10},cardTop:{flexDirection:"row",gap:12,alignItems:"center"},image:{width:76,height:76,borderRadius:13,backgroundColor:"#eef6f4"},placeholder:{alignItems:"center",justifyContent:"center"},body:{flex:1},name:{color:"#062f4f",fontSize:15,fontWeight:"900"},category:{color:"#66858d",fontSize:11,marginTop:3},meta:{flexDirection:"row",alignItems:"center",gap:6,marginTop:7,flexWrap:"wrap"},pill:{backgroundColor:"#e8f7f4",borderRadius:99,paddingHorizontal:8,paddingVertical:4},pillText:{color:"#087f72",fontSize:10,fontWeight:"800"},statusPill:{borderRadius:99,paddingHorizontal:7,paddingVertical:4},statusValued:{backgroundColor:"#e8f7f4"},statusMissing:{backgroundColor:"#fff5e8"},statusText:{fontSize:9,fontWeight:"900"},statusTextValued:{color:"#087f72"},statusTextMissing:{color:"#9a6418"},remove:{padding:8},
 valueRow:{borderTopWidth:1,borderTopColor:"#edf4f2",marginTop:11,paddingTop:11,flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:10},valueLabel:{color:"#789097",fontSize:9,fontWeight:"900",letterSpacing:.6},value:{color:"#062f4f",fontSize:22,fontWeight:"900",marginTop:2},noValue:{color:"#66858d",fontSize:14,fontWeight:"800",marginTop:3},date:{color:"#789097",fontSize:9,marginTop:3},refreshButton:{minHeight:38,borderRadius:12,borderWidth:1,borderColor:"#b9ddd5",backgroundColor:"#f4fbf9",paddingHorizontal:11,flexDirection:"row",gap:6,alignItems:"center",justifyContent:"center"},refreshText:{color:"#087f72",fontSize:11,fontWeight:"900"},
 empty:{backgroundColor:"#fff",borderWidth:1,borderColor:"#d9ebe7",borderRadius:24,padding:24,alignItems:"center",marginTop:8},emptyIcon:{width:68,height:68,borderRadius:34,backgroundColor:"#e8f7f4",alignItems:"center",justifyContent:"center"},emptyTitle:{color:"#062f4f",fontSize:21,fontWeight:"900",marginTop:15},emptyCopy:{color:"#66858d",fontSize:13,lineHeight:20,textAlign:"center",marginTop:6},primary:{minHeight:52,borderRadius:15,backgroundColor:"#0aaf86",flexDirection:"row",gap:8,alignItems:"center",justifyContent:"center",paddingHorizontal:22,marginTop:18},primaryText:{color:"#fff",fontSize:14,fontWeight:"900"},
 historyBox:{borderTopWidth:1,borderTopColor:"#edf4f2",marginTop:11,paddingTop:11},historyHeader:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:8,marginBottom:7},historyEyebrow:{color:"#087f72",fontSize:9,fontWeight:"900",letterSpacing:.7},historyTitle:{color:"#062f4f",fontSize:12,fontWeight:"800",marginTop:2},changePill:{borderRadius:99,paddingHorizontal:8,paddingVertical:5},changeUp:{backgroundColor:"#e8f7f4"},changeDown:{backgroundColor:"#fff1ed"},changeFlat:{backgroundColor:"#f0f4f4"},changeText:{color:"#315d63",fontSize:9,fontWeight:"900"},historyRow:{minHeight:40,flexDirection:"row",alignItems:"stretch"},timeline:{width:18,alignItems:"center"},dot:{width:8,height:8,borderRadius:4,backgroundColor:"#a8c7c1",marginTop:7},dotLatest:{backgroundColor:"#0a9b80"},line:{width:1,flex:1,backgroundColor:"#d5e8e4",marginVertical:2},historyBody:{flex:1,paddingBottom:8},historyMoney:{color:"#173f51",fontSize:13,fontWeight:"900"},historyDate:{color:"#789097",fontSize:9,marginTop:1},latest:{color:"#087f72",fontSize:8,fontWeight:"900",letterSpacing:.5,marginTop:4},historyHint:{color:"#66858d",fontSize:10,lineHeight:15,backgroundColor:"#f4fbf9",borderRadius:10,padding:9,marginTop:2},
 openDetail:{borderTopWidth:1,borderTopColor:"#edf4f2",marginTop:10,paddingTop:10,flexDirection:"row",alignItems:"center",justifyContent:"flex-end",gap:4},openDetailText:{color:"#087f72",fontSize:10,fontWeight:"900"},
  disclaimer:{flexDirection:"row",gap:7,backgroundColor:"#f0f6f5",borderRadius:13,padding:11,marginTop:5},disclaimerText:{flex:1,color:"#66858d",fontSize:10,lineHeight:15},note:{color:"#789097",fontSize:10,lineHeight:15,textAlign:"center",marginTop:12}
});
