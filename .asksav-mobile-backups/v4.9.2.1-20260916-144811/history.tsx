...
export default function HistoryScreen(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  ...
  {items.map(e=>{const value=valueOf(e),conf=confidenceOf(e);return <TouchableOpacity key={String(e.id)} style={s.card} onPress={()=>router.push({pathname:"/history-detail",params:{id:String(e.id)}})}>
    {e.imageUri?<Image source={{uri:e.imageUri}} style={s.thumb}/>:<View style={[s.thumb,s.thumbEmpty]}><Ionicons name="image-outline" size={24} color="#789097"/></View>}
    ...
    </View><Ionicons name="chevron-forward" size={19} color="#789097"/>
  </TouchableOpacity>})}
 </ScrollView></SafeAreaView>
}
const s=StyleSheet.create({
 safe:{flex:1,backgroundColor:"#f4fbf9"},page:{padding:22,paddingBottom:40},eyebrow:{color:"#0a9b80",fontSize:12,fontWeight:"900",letterSpacing:1.1,marginTop:18},title:{color:"#062f4f",fontSize:38,fontWeight:"900",marginTop:5},sub:{color:"#66858d",fontSize:14,lineHeight:20,marginTop:5,marginBottom:18},
 card:{backgroundColor:"#fff",borderWidth:1,borderColor:"#cfe8e2",borderRadius:18,padding:12,marginBottom:11,flexDirection:"row",alignItems:"center",gap:12},thumb:{width:72,height:72,borderRadius:14,backgroundColor:"#f0f6f5"},thumbEmpty:{alignItems:"center",justifyContent:"center"},body:{flex:1},name:{color:"#062f4f",fontSize:16,fontWeight:"900",lineHeight:20},badges:{flexDirection:"row",flexWrap:"wrap",gap:5,marginTop:7},badge:{backgroundColor:"#e8f7f4",borderRadius:99,paddingHorizontal:7,paddingVertical:4},badgeText:{color:"#087f72",fontSize:10,fontWeight:"800"},meta:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginTop:8},value:{color:"#062f4f",fontSize:15,fontWeight:"900"},date:{color:"#789097",fontSize:11,fontWeight:"700"},
 empty:{backgroundColor:"#fff",borderWidth:1,borderColor:"#cfe8e2",borderRadius:22,padding:24,alignItems:"center",marginTop:8},emptyIcon:{width:62,height:62,borderRadius:31,backgroundColor:"#e8f7f4",alignItems:"center",justifyContent:"center"},emptyTitle:{color:"#062f4f",fontSize:21,fontWeight:"900",marginTop:14},emptyCopy:{color:"#66858d",fontSize:14,lineHeight:21,textAlign:"center",marginTop:6},primary:{minHeight:50,borderRadius:15,backgroundColor:"#0aaf86",alignItems:"center",justifyContent:"center",alignSelf:"stretch",marginTop:18},primaryText:{color:"#fff",fontSize:14,fontWeight:"900"}
});