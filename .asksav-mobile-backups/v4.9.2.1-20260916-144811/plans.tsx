...
const s=StyleSheet.create({
 safe:{flex:1,backgroundColor:"#f4fbf9"},page:{padding:22,paddingBottom:40},back:{flexDirection:"row",alignItems:"center",alignSelf:"flex-start",marginTop:10,marginBottom:12},backText:{color:"#087f72",fontSize:14,fontWeight:"800"},
 eyebrow:{color:"#0a9b80",fontSize:12,fontWeight:"900",letterSpacing:1.1},title:{color:"#062f4f",fontSize:34,lineHeight:40,fontWeight:"900",marginTop:6},copy:{color:"#5f7c86",fontSize:14,lineHeight:21,marginTop:8,marginBottom:18},
 card:{backgroundColor:"#fff",borderRadius:22,padding:19,borderWidth:2,marginBottom:14},free:{borderColor:"#63c7ad"},plus:{borderColor:"#8f7bd8"},pro:{borderColor:"#315a86"},
 planTop:{flexDirection:"row",alignItems:"center",gap:11},icon:{width:44,height:44,borderRadius:13,backgroundColor:"#e8f7f4",alignItems:"center",justifyContent:"center"},name:{color:"#062f4f",fontSize:22,fontWeight:"900"},strap:{color:"#66858d",fontSize:12,marginTop:2},
 current:{backgroundColor:"#e8f7f4",borderRadius:99,paddingHorizontal:9,paddingVertical:6},currentText:{color:"#087f72",fontSize:10,fontWeight:"900",letterSpacing:.5},
 features:{marginTop:15,borderTopWidth:1,borderTopColor:"#edf4f2",paddingTop:10},feature:{flexDirection:"row",alignItems:"center",gap:8,paddingVertical:5},featureText:{color:"#385765",fontSize:14,fontWeight:"700"},
 choose:{backgroundColor:"#edf3f5",borderRadius:14,minHeight:55,alignItems:"center",justifyContent:"center",marginTop:13},chooseText:{color:"#49656f",fontSize:14,fontWeight:"900"},soon:{color:"#789097",fontSize:10,marginTop:2},
 activeButton:{backgroundColor:"#e8f7f4",borderRadius:14,minHeight:50,alignItems:"center",justifyContent:"center",marginTop:13},activeText:{color:"#087f72",fontSize:14,fontWeight:"900"},
 note:{backgroundColor:"#eef9ff",borderWidth:1,borderColor:"#bedce9",borderRadius:18,padding:15,flexDirection:"row",gap:11,marginTop:2},noteTitle:{color:"#062f4f",fontSize:14,fontWeight:"900"},noteText:{color:"#5f7c86",fontSize:12,lineHeight:18,marginTop:3}
});
