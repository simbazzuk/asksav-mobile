...
import {ActivityIndicator, Alert, Image, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, Share} from "react-native";
...
export default function HomeScreen() {
  ...
  async function saveToCollection() {
    ...
    try {
      ...
      Alert.alert("Saved to My Collection","This item is now available from the Collection tab on this device.");
    } catch(e) {
      console.warn("[AskSAV mobile] Collection save failed",e);
      Alert.alert("Could not save item","AskSAV could not save this item to My Collection.");
    }
  }
        ...
        <ScrollView contentContainerStyle={s.previewPage}>
          ...
          <TouchableOpacity style={s.primary} onPress={usePhoto} disabled={analysing}>
            ...
            {marketData ? <View style={s.marketActionsCard}>
              ...
              <View style={s.marketActionsGrid}>
                {getMarketActions(bestIdentification(analysis,itemName),category).map((action:MarketAction)=><TouchableOpacity key={action.id} style={s.marketAction} onPress={async()=>{try{const ok=await Linking.canOpenURL(action.url);if(ok)await Linking.openURL(action.url);else Alert.alert("Link unavailable","This destination could not be opened.");}catch{Alert.alert("Link unavailable","This destination could not be opened.");}}}>
                  ...
                  <Ionicons name="open-outline" size={17} color="#789097"/>
                </TouchableOpacity>)}
              </View>
            ...
            <TouchableOpacity style={[s.collectionButton,collectionSaved&&s.collectionButtonSaved]} onPress={saveToCollection} disabled={collectionSaved}>
              <Ionicons name={collectionSaved?"checkmark-circle":"bookmark-outline"} size={20} color={collectionSaved?"#087f72":"#fff"}/>
...
const s=StyleSheet.create({
  ...
  collectionButtonSaved:{backgroundColor:"#e8f7f4",borderWidth:1,borderColor:"#b9ddd5"},
  collectionButtonText:{color:"#fff",fontSize:15,fontWeight:"900"},
  collectionButtonTextSaved:{color:"#087f72"},

  marketActionsCard:{backgroundColor:"#fff",borderWidth:1,borderColor:"#cfe8e2",borderRadius:20,padding:18,marginBottom:12},
  marketActionsEyebrow:{color:"#087f72",fontSize:10,fontWeight:"900",letterSpacing:.9},
  marketActionsTitle:{color:"#062f4f",fontSize:20,fontWeight:"900",marginTop:4},
  marketActionsCopy:{color:"#5f7c86",fontSize:13,lineHeight:19,marginTop:4,marginBottom:12},
  marketActionsGrid:{gap:8},
  marketAction:{minHeight:68,borderWidth:1,borderColor:"#d8ebe7",borderRadius:15,padding:11,flexDirection:"row",alignItems:"center",gap:10,backgroundColor:"#f8fcfb"},
  marketActionIcon:{width:40,height:40,borderRadius:12,backgroundColor:"#e8f7f4",alignItems:"center",justifyContent:"center"},
  marketActionTitle:{color:"#062f4f",fontSize:14,fontWeight:"900"},
  marketActionCopy:{color:"#66858d",fontSize:11,lineHeight:16,marginTop:2},
  partnerNote:{color:"#789097",fontSize:10,lineHeight:15,marginTop:12},
  ...
  frameTip:{position:"absolute",bottom:14,flexDirection:"row",alignItems:"center",gap:6,backgroundColor:"rgba(255,255,255,0.94)",borderRadius:99,paddingHorizontal:11,paddingVertical:7,borderWidth:1,borderColor:"#cfe8e2"},
  frameTipText:{color:"#087f72",fontSize:11,fontWeight:"800"},
  confidenceToggle:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",paddingVertical:10,borderTopWidth:1,borderTopColor:"#edf4f2"},
  ...
  shareMini:{flexDirection:"row",alignItems:"center",gap:5,paddingHorizontal:9,paddingVertical:6,borderRadius:99,backgroundColor:"#e8f7f4"},
  ...
  contextTitle:{color:"#062f4f",fontSize:15,fontWeight:"900"},
  ...
  contextInput:{minHeight:78,backgroundColor:"#fff",borderWidth:1,borderColor:"#cfe8e2",borderRadius:14,paddingHorizontal:13,paddingVertical:11,color:"#173f51",fontSize:14,lineHeight:20},
  contextCount:{color:"#789097",fontSize:11,fontWeight:"700",textAlign:"right",marginTop:6},
 ...
 marketRange:{color:"#062f4f",fontSize:30,fontWeight:"900",marginTop:5},
 marketSuggested:{color:"#173f51",fontSize:15,fontWeight:"800",marginTop:8},
 marketQuick:{color:"#5f7c86",fontSize:14,fontWeight:"700",marginTop:3},
 ...
 marketErrorCard:{backgroundColor:"#fff7f3",borderWidth:1,borderColor:"#f0c9b8",borderRadius:16,padding:14,marginTop:10},
 marketErrorText:{color:"#8a4933",fontSize:13,lineHeight:19,fontWeight:"700"},
 progressCard:{backgroundColor:"#ffffff",borderWidth:1,borderColor:"#cfe8e2",borderRadius:18,padding:15,marginBottom:12},
 progressTop:{flexDirection:"row",alignItems:"center",justifyContent:"space-between"},
 progressTitle:{color:"#062f4f",fontSize:15,fontWeight:"900"},
 ...
 progressStage:{color:"#66858d",fontSize:12,fontWeight:"700",marginTop:8}
});
