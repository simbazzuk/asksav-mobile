// AskSAV Mobile v4.6.0.4 - Cloud Sync Status UI
...
export default function CollectionScreen(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  ...
  <Text style={s.note}>Your Collection is securely synced to your AskSAV account when cloud sync is available.</Text>
