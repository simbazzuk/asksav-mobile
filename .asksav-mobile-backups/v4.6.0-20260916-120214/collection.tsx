// AskSAV Mobile v4.5.0 - Collection Item Detail
...
export default function CollectionScreen(){
 ...
 async function remove(id:string){await persist(items.filter(x=>x.id!==id));}
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  <View style={s.brandRow}><View style={s.logo}><Text style={s.logoText}>SAV</Text></View><View><Text style={s.brand}>My Collection</Text><Text style={s.brandSub}>Understand what your saved items may be worth</Text></View></View>
  ...
  <Text style={s.note}>My Collection and Value History remain stored on this device in v4.4.0. Removing the app may remove locally saved data.</Text>
