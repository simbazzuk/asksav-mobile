...
const s=StyleSheet.create({
 ...
 previewTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:32,lineHeight:38,fontWeight:"900",marginTop:7},previewCopy:{color:DynamicColorIOS({light:"#5f7c86",dark:"#c7d9da"}),fontSize:15,lineHeight:22,marginTop:8},imageFrame:{height:390,backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderRadius:24,borderWidth:1,borderColor:"#d9ebe7",overflow:"hidden",marginTop:22,marginBottom:10},imageFrameResult:{height:260},image:{width:"100%",height:"100%"},
