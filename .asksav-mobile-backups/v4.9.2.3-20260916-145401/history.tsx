...
export default function HistoryScreen(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  <Text style={s.eyebrow}>YOUR ASKSAV</Text><Text style={s.title}>History</Text>
...
const s=StyleSheet.create({
 safe:{flex:1,backgroundColor:DynamicColorIOS({light:"#f4fbf9",dark:"#07191d"})},page:{padding:22,paddingBottom:40},eyebrow:{color:"#0a9b80",fontSize:12,fontWeight:"900",letterSpacing:1.1,marginTop:18},title:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:38,fontWeight:"900",marginTop:5},sub:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:14,lineHeight:20,marginTop:5,marginBottom:18},
