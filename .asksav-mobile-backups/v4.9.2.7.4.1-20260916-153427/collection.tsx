...
export default function CollectionScreen(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  ...
  <View style={s.disclaimer}><Ionicons name="information-circle-outline" size={16} color={DynamicColorIOS({light:"#66858d",dark:"#315e66"})}/><Text style={s.disclaimerText}>Collection values are indicative Market Intelligence, not formal valuations or guaranteed sale prices.</Text></View>
...
const s=StyleSheet.create({
 ...
 openDetail:{borderTopWidth:1,borderTopColor:DynamicColorIOS({light:"#edf4f2",dark:"#24464c"}),marginTop:10,paddingTop:10,flexDirection:"row",alignItems:"center",justifyContent:"flex-end",gap:4},openDetailText:{color:"#087f72",fontSize:10,fontWeight:"900"},
  disclaimer:{flexDirection:"row",gap:7,backgroundColor:"#f0f6f5",borderRadius:13,padding:11,marginTop:5},disclaimerText:{flex:1,color:DynamicColorIOS({light:"#66858d",dark:"#315e66"}),fontSize:10,lineHeight:15},note:{color:DynamicColorIOS({light:"#789097",dark:"#c7d9da"}),fontSize:10,lineHeight:15,textAlign:"center",marginTop:12}
});
