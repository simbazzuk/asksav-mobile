      ...
      <SafeAreaView style={s.safe}>
        <ScrollView contentContainerStyle={s.previewPage}>
          ...
          {!analysis ? <View style={s.contextCard}>
            <View style={s.contextHeader}><Ionicons name="information-circle-outline" size={19} color="#087f72"/><Text style={s.contextTitle}>Add context (optional)</Text></View>
            <Text style={s.contextHelp}>A brand, approximate age, markings or where the item came from can help AskSAV classify it. Treat guesses as guesses.</Text>
            <TextInput
              style={s.contextInput}
              value={itemContext}
              onChangeText={(value)=>setItemContext(value.slice(0,400))}
              placeholder="e.g. Bought in the UK around 2015. The label may say Lenovo."
