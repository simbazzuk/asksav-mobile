 ...
 if(!user) return <SafeAreaView style={s.safe}>
   <KeyboardAvoidingView style={{flex:1}} behavior={Platform.OS==="ios"?"padding":undefined}>
    <ScrollView contentContainerStyle={s.page} keyboardShouldPersistTaps="handled">
     <View style={s.pageHeader}><Image source={require("../../assets/images/asksav-brand-green.png")} style={s.headerLogo} resizeMode="contain"/><View style={s.headerCopy}><Text style={s.eyebrow}>YOUR ASKSAV</Text><Text style={s.title}>Account</Text></View></View>
     <View style={s.card}>
