...
export default function HomeScreen() {
  ...
  async function loadMarketIntelligence() {
    ...
    try {
      ...
      try { const raw=await AsyncStorage.getItem("asksav.mobile.history.v1"); const entries=raw?JSON.parse(raw):[]; const updated=entries.map((e,index)=>index===0&&e?.imageUri===imageUri?{...e,market}:e); await AsyncStorage.setItem("asksav.mobile.history.v1",JSON.stringify(updated)); } catch(e){console.warn("[AskSAV mobile] Market history save failed",e);}
    } catch (e:any) {
    ...
    return (
      <SafeAreaView style={s.safe}>
        <ScrollView contentContainerStyle={s.previewPage}>
          <View style={s.brandRow}><View style={s.logo}><Image source={require("../../assets/images/asksav-brand-green.png")} style={{width:74,height:74,borderRadius:18}} resizeMode="contain"/></View><View><Text style={s.brand}>AskSAV</Text><Text style={s.brandSub}>Visual Intelligence</Text></View></View>
          ...
          {!analysis ? <View style={s.contextCard}>
            ...
            <TextInput
              ...
              placeholderTextColor={DynamicColorIOS({light:"#789097",dark:"#9db7b9"})}
              multiline
              maxLength={400}
              editable={!analysing}
            ...
            {marketData ? <View style={s.marketActionsCard}>
              ...
              <View style={s.marketActionsGrid}>
                {getMarketActions(bestIdentification(analysis,itemName),category).map((action:MarketAction)=><TouchableOpacity key={action.id} style={s.marketAction} onPress={async()=>{try{const ok=await Linking.canOpenURL(action.url);if(ok)await Linking.openURL(action.url);else Alert.alert("Link unavailable","This destination could not be opened.");}catch{Alert.alert("Link unavailable","This destination could not be opened.");}}}>
                  ...
                  <Ionicons name="open-outline" size={17} color={DynamicColorIOS({light:"#789097",dark:"#9db7b9"})}/>
                </TouchableOpacity>)}
              </View>
  ...
  return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
    <View style={s.brandRow}><Image source={require("../../assets/images/asksav-brand-green.png")} style={s.brandLogo} resizeMode="contain"/><View><Text style={s.brand}>AskSAV</Text><Text style={s.brandSub}>Visual Intelligence</Text></View></View>
...
const s=StyleSheet.create({
  ...
  marketActionsTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:20,fontWeight:"900",marginTop:4},
  marketActionsCopy:{color:DynamicColorIOS({light:"#5f7c86",dark:"#9db7b9"}),fontSize:13,lineHeight:19,marginTop:4,marginBottom:12},
  ...
  marketActionTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:14,fontWeight:"900"},
  marketActionCopy:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:11,lineHeight:16,marginTop:2},
  partnerNote:{color:DynamicColorIOS({light:"#789097",dark:"#9db7b9"}),fontSize:10,lineHeight:15,marginTop:12},
  ...
  confidenceInfo:{backgroundColor:"#f0faf7",borderRadius:12,padding:11,marginBottom:5},confidenceInfoText:{color:"#557681",fontSize:12,lineHeight:18},
  ...
  contextCard:{backgroundColor:"#f0faf7",borderWidth:1,borderColor:"#b9ddd5",borderRadius:18,padding:15,marginTop:12},
  ...
  contextTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:15,fontWeight:"900"},
  optionalPill:{backgroundColor:"#dff3ed",borderRadius:99,paddingHorizontal:9,paddingVertical:4},
  optionalText:{color:"#087f72",fontSize:11,fontWeight:"800"},
  contextInput:{minHeight:78,backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderWidth:1,borderColor:DynamicColorIOS({light:"#cfe8e2",dark:"#24464c"}),borderRadius:14,paddingHorizontal:13,paddingVertical:11,color:DynamicColorIOS({light:"#173f51",dark:"#eefbf8"}),fontSize:14,lineHeight:20},
  contextCount:{color:DynamicColorIOS({light:"#789097",dark:"#9db7b9"}),fontSize:11,fontWeight:"700",textAlign:"right",marginTop:6},
 ...
 brandRow:{flexDirection:"row",alignItems:"center",gap:11},logo:{width:48,height:48,borderRadius:15,backgroundColor:"#13b8aa",alignItems:"center",justifyContent:"center"},logoText:{color:DynamicColorIOS({light:"#fff",dark:"#10282d"}),fontWeight:"900",fontSize:16},brand:{color:"#082f49",fontSize:24,fontWeight:"900"},brandSub:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:11},
 hero:{marginTop:38},eyebrow:{color:"#0a9b80",fontSize:12,fontWeight:"900",letterSpacing:1.2,marginTop:30},title:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:38,lineHeight:43,fontWeight:"900",marginTop:8},subtitle:{color:"#4f6f7b",fontSize:16,lineHeight:24,marginTop:12},
 card:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderRadius:26,padding:24,marginTop:30,borderWidth:1,borderColor:"#d9ebe7",shadowColor:"#000",shadowOpacity:.06,shadowRadius:18,shadowOffset:{width:0,height:8},elevation:3},camera:{width:78,height:78,borderRadius:39,backgroundColor:"#e7f8f4",alignItems:"center",justifyContent:"center",alignSelf:"center"},cardTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:25,fontWeight:"900",textAlign:"center",marginTop:18},copy:{color:"#67818a",fontSize:14,lineHeight:21,textAlign:"center",marginTop:7,marginBottom:22},
 primary:{minHeight:56,borderRadius:16,backgroundColor:"#0aaf86",flexDirection:"row",gap:9,alignItems:"center",justifyContent:"center",marginTop:12},primaryText:{color:DynamicColorIOS({light:"#fff",dark:"#10282d"}),fontSize:16,fontWeight:"900"},secondary:{minHeight:54,borderRadius:16,marginTop:11,borderWidth:1,borderColor:"#b9ddd5",flexDirection:"row",gap:9,alignItems:"center",justifyContent:"center"},secondaryText:{color:"#087f72",fontSize:14,fontWeight:"800"},
 previewTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:32,lineHeight:38,fontWeight:"900",marginTop:7},previewCopy:{color:DynamicColorIOS({light:"#5f7c86",dark:"#9db7b9"}),fontSize:15,lineHeight:22,marginTop:8},imageFrame:{height:390,backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderRadius:24,borderWidth:1,borderColor:"#d9ebe7",overflow:"hidden",marginTop:22,marginBottom:10},imageFrameResult:{height:260},image:{width:"100%",height:"100%"},
 ...
 resultCard:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderWidth:1,borderColor:DynamicColorIOS({light:"#cfe8e2",dark:"#24464c"}),borderRadius:20,padding:18,marginTop:12},sectionTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:19,fontWeight:"900",marginBottom:5},resultRow:{flexDirection:"row",gap:12,paddingVertical:11,borderTopWidth:1,borderTopColor:DynamicColorIOS({light:"#edf4f2",dark:"#24464c"})},resultIcon:{width:34,height:34,borderRadius:10,backgroundColor:DynamicColorIOS({light:"#e8f7f4",dark:"#17383d"}),alignItems:"center",justifyContent:"center"},resultBody:{flex:1},resultLabel:{color:DynamicColorIOS({light:"#789097",dark:"#9db7b9"}),fontSize:11,fontWeight:"800",textTransform:"uppercase",letterSpacing:.5},resultValue:{color:DynamicColorIOS({light:"#173f51",dark:"#eefbf8"}),fontSize:15,lineHeight:21,fontWeight:"700",marginTop:2},detailText:{color:DynamicColorIOS({light:"#5f7c86",dark:"#9db7b9"}),fontSize:14,lineHeight:21,marginTop:8},
 valueCard:{backgroundColor:DynamicColorIOS({light:"#e8f7f4",dark:"#17383d"}),borderWidth:1,borderColor:"#b9ddd5",borderRadius:20,padding:18,marginTop:12,flexDirection:"row",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap"},valueLabel:{color:"#087f72",fontSize:11,fontWeight:"900",letterSpacing:.8},valueAmount:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:30,fontWeight:"900",marginTop:3},valueNote:{width:"100%",color:DynamicColorIOS({light:"#5f7c86",dark:"#9db7b9"}),fontSize:12,lineHeight:18,marginTop:10},
 marketButton:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderWidth:1.5,borderColor:"#8fd4c8",borderRadius:20,padding:15,marginTop:12,flexDirection:"row",alignItems:"center",gap:12},marketIcon:{width:42,height:42,borderRadius:13,backgroundColor:"#087f72",alignItems:"center",justifyContent:"center"},marketTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:16,fontWeight:"900"},marketCopy:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:12,lineHeight:17,marginTop:2},
 cancel:{color:"#647b83",fontSize:14,fontWeight:"800",textAlign:"center",paddingVertical:18},
 marketResultCard:{backgroundColor:"#f0faf7",borderWidth:1,borderColor:"#b9ddd5",borderRadius:20,padding:18,marginTop:12},
 marketResultEyebrow:{color:"#087f72",fontSize:11,fontWeight:"900",letterSpacing:.8},
 marketRange:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:30,fontWeight:"900",marginTop:5},
 marketSuggested:{color:DynamicColorIOS({light:"#173f51",dark:"#eefbf8"}),fontSize:15,fontWeight:"800",marginTop:8},
 marketQuick:{color:DynamicColorIOS({light:"#5f7c86",dark:"#9db7b9"}),fontSize:14,fontWeight:"700",marginTop:3},
 marketEvidenceLabel:{color:"#087f72",fontSize:11,fontWeight:"900",letterSpacing:.7,marginTop:16},marketEvidence:{color:"#4f6f7b",fontSize:14,lineHeight:21,marginTop:6},
 ...
 progressTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:15,fontWeight:"900"},
 ...
 progressStage:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:12,fontWeight:"700",marginTop:8}
});
