...
export default function HistoryScreen(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  <View style={s.pageHeader}><Image source={require("../../assets/images/asksav-brand-green.png")} style={s.headerLogo} resizeMode="contain"/><View style={s.headerCopy}><Text style={s.eyebrow}>YOUR ASKSAV</Text><Text style={s.title}>History</Text></View></View>
  <Text style={s.sub}>Your recent analyses are stored on this device.</Text>
  ...
  {items.map(e=>{const value=valueOf(e),conf=confidenceOf(e);return <TouchableOpacity key={String(e.id)} style={s.card} onPress={()=>router.push({pathname:"/history-detail",params:{id:String(e.id)}})}>
    {e.imageUri?<Image source={{uri:e.imageUri}} style={s.thumb}/>:<View style={[s.thumb,s.thumbEmpty]}><Ionicons name="image-outline" size={24} color={DynamicColorIOS({light:"#789097",dark:"#9db7b9"})}/></View>}
    ...
    </View><Ionicons name="chevron-forward" size={19} color={DynamicColorIOS({light:"#789097",dark:"#9db7b9"})}/>
  </TouchableOpacity>})}
...
const s=StyleSheet.create({
 ...
 safe:{flex:1,backgroundColor:DynamicColorIOS({light:"#f4fbf9",dark:"#07191d"})},page:{padding:22,paddingBottom:40},eyebrow:{color:"#0a9b80",fontSize:12,fontWeight:"900",letterSpacing:1.1},title:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:38,fontWeight:"900",marginTop:2},sub:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:14,lineHeight:20,marginTop:5,marginBottom:18},
 card:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderWidth:1,borderColor:DynamicColorIOS({light:"#cfe8e2",dark:"#24464c"}),borderRadius:18,padding:12,marginBottom:11,flexDirection:"row",alignItems:"center",gap:12},thumb:{width:72,height:72,borderRadius:14,backgroundColor:"#f0f6f5"},thumbEmpty:{alignItems:"center",justifyContent:"center"},body:{flex:1},name:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:16,fontWeight:"900",lineHeight:20},badges:{flexDirection:"row",flexWrap:"wrap",gap:5,marginTop:7},badge:{backgroundColor:DynamicColorIOS({light:"#e8f7f4",dark:"#17383d"}),borderRadius:99,paddingHorizontal:7,paddingVertical:4},badgeText:{color:"#087f72",fontSize:10,fontWeight:"800"},meta:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginTop:8},value:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:15,fontWeight:"900"},date:{color:DynamicColorIOS({light:"#789097",dark:"#9db7b9"}),fontSize:11,fontWeight:"700"},
 empty:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderWidth:1,borderColor:DynamicColorIOS({light:"#cfe8e2",dark:"#24464c"}),borderRadius:22,padding:24,alignItems:"center",marginTop:8},emptyIcon:{width:62,height:62,borderRadius:31,backgroundColor:DynamicColorIOS({light:"#e8f7f4",dark:"#17383d"}),alignItems:"center",justifyContent:"center"},emptyTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:21,fontWeight:"900",marginTop:14},emptyCopy:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:14,lineHeight:21,textAlign:"center",marginTop:6},primary:{minHeight:50,borderRadius:15,backgroundColor:"#0aaf86",alignItems:"center",justifyContent:"center",alignSelf:"stretch",marginTop:18},primaryText:{color:DynamicColorIOS({light:"#fff",dark:"#10282d"}),fontSize:14,fontWeight:"900"}
});