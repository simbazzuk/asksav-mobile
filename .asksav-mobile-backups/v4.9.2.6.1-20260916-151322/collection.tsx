...
export default function CollectionScreen(){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  <View style={s.brandRow}><Image source={require("../../assets/images/asksav-brand-green.png")} style={s.brandLogo} resizeMode="contain"/><View style={s.brandCopy}><Text style={s.brand}>My Collection</Text><Text style={s.brandSub}>Understand what your saved items may be worth</Text>
...
const s=StyleSheet.create({
 ...
 brandRow:{flexDirection:"row",alignItems:"center",gap:11},brandLogo:{width:58,height:58,borderRadius:16},brandCopy:{flex:1},syncRow:{flexDirection:"row",alignItems:"center",gap:4,marginTop:4},syncText:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:9,fontWeight:"700"},logo:{width:48,height:48,borderRadius:15,backgroundColor:"#13b8aa",alignItems:"center",justifyContent:"center"},logoText:{color:DynamicColorIOS({light:"#fff",dark:"#10282d"}),fontWeight:"900",fontSize:16},brand:{color:"#082f49",fontSize:24,fontWeight:"900"},brandSub:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:11},
