// AskSAV Mobile v4.3.0 - Collection Value Dashboard
...
type Item={id:string;savedAt:string;name?:string;category?:string;condition?:string;confidence?:string;imageUri?:string;analysis?:any;market?:any;marketUpdatedAt?:string};
...
export default function CollectionScreen(){
 ...
 async function refreshMarketValue(item:Item){
  ...
  try{
   ...
   const next=items.map(x=>x.id===item.id?{...x,market,marketUpdatedAt:now}:x);
   await persist(next);
  }catch(e){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
  ...
  <Text style={s.note}>My Collection remains stored on this device in v4.3.0. Removing the app may remove locally saved collection data.</Text>
