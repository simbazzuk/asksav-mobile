...
export default function RootLayout() {
  ...
  return (
    <Tabs initialRouteName="index" backBehavior="history" screenOptions={{headerShown:false,tabBarActiveTintColor:"#08b58c",tabBarInactiveTintColor:dark?"#8ca7aa":"#78909c",tabBarStyle:{height:78,paddingTop:8,paddingBottom:12,borderTopColor:dark?"#24464c":"#dce9e7",backgroundColor:dark?"#07191d":"#fff"},tabBarLabelStyle:{fontSize:12,fontWeight:"700"}}}>
