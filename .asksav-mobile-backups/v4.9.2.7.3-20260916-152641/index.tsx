...
const s=StyleSheet.create({
 ...
 hero:{marginTop:26},eyebrow:{color:"#0a9b80",fontSize:12,fontWeight:"900",letterSpacing:1.2,marginTop:30},title:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:38,lineHeight:43,fontWeight:"900",marginTop:8},subtitle:{color:DynamicColorIOS({light:"#4f6f7b",dark:"#b8ced0"}),fontSize:16,lineHeight:24,marginTop:12},
 card:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#123137"}),borderRadius:26,padding:24,marginTop:30,borderWidth:1,borderColor:DynamicColorIOS({light:"#d9ebe7",dark:"#3a666a"}),shadowColor:"#000",shadowOpacity:.06,shadowRadius:18,shadowOffset:{width:0,height:8},elevation:3},camera:{width:78,height:78,borderRadius:39,backgroundColor:DynamicColorIOS({light:"#e7f8f4",dark:"#1b4448"}),alignItems:"center",justifyContent:"center",alignSelf:"center"},cardTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:25,fontWeight:"900",textAlign:"center",marginTop:18},copy:{color:DynamicColorIOS({light:"#67818a",dark:"#b8ced0"}),fontSize:14,lineHeight:21,textAlign:"center",marginTop:7,marginBottom:22},
