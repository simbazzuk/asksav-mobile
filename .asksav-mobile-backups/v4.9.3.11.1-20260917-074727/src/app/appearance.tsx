...
const s=StyleSheet.create({
 ...
 title:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:30,lineHeight:34,fontWeight:"900"},copy:{color:DynamicColorIOS({light:"#66858d",dark:"#9db7b9"}),fontSize:14,marginTop:5,marginBottom:22},
