...
export default function CollectionDetail(){
 ...
 async function refreshValue(){
  ...
  try{
   ...
   await AsyncStorage.setItem(KEY,JSON.stringify(next));setItem(next.find(x=>x.id===item.id)||null);
...
const s=StyleSheet.create({
 safe:{flex:1,backgroundColor:"#f4fbf9"},page:{paddingHorizontal:20,paddingTop:10,paddingBottom:38},back:{flexDirection:"row",alignItems:"center",gap:2,paddingVertical:10,alignSelf:"flex-start"},backLabel:{color:"#087f72",fontSize:14,fontWeight:"900"},heroImage:{width:"100%",height:250,backgroundColor:"#fff",borderRadius:22,borderWidth:1,borderColor:"#d9ebe7",marginTop:4},eyebrow:{color:"#087f72",fontSize:10,fontWeight:"900",letterSpacing:.9,marginTop:18},title:{color:"#062f4f",fontSize:30,lineHeight:35,fontWeight:"900",marginTop:4},category:{color:"#66858d",fontSize:13,marginTop:4},
 card:{backgroundColor:"#fff",borderWidth:1,borderColor:"#d9ebe7",borderRadius:19,padding:16,marginTop:12},sectionTitle:{color:"#062f4f",fontSize:18,fontWeight:"900"},sectionCopy:{color:"#66858d",fontSize:11,lineHeight:17,marginTop:3,marginBottom:8},row:{flexDirection:"row",justifyContent:"space-between",gap:14,paddingVertical:10,borderTopWidth:1,borderTopColor:"#edf4f2"},rowLabel:{color:"#789097",fontSize:11,fontWeight:"800"},rowValue:{flex:1,color:"#173f51",fontSize:13,fontWeight:"800",textAlign:"right"},notes:{color:"#5f7c86",fontSize:12,lineHeight:18,marginTop:8},
 valueCard:{backgroundColor:"#e8f7f4",borderWidth:1,borderColor:"#b9ddd5",borderRadius:20,padding:17,marginTop:12},valueEyebrow:{color:"#087f72",fontSize:10,fontWeight:"900",letterSpacing:.7},value:{color:"#062f4f",fontSize:32,fontWeight:"900",marginTop:3},range:{color:"#5f7c86",fontSize:11,marginTop:3},refresh:{minHeight:48,borderRadius:14,backgroundColor:"#087f72",flexDirection:"row",gap:8,alignItems:"center",justifyContent:"center",marginTop:13},refreshText:{color:"#fff",fontSize:13,fontWeight:"900"},
 historyRow:{minHeight:48,flexDirection:"row",alignItems:"center",gap:10,borderTopWidth:1,borderTopColor:"#edf4f2"},dot:{width:9,height:9,borderRadius:5,backgroundColor:"#a8c7c1"},dotLatest:{backgroundColor:"#0a9b80"},historyMoney:{color:"#173f51",fontSize:14,fontWeight:"900"},historyDate:{color:"#789097",fontSize:9,marginTop:2},latest:{color:"#087f72",fontSize:8,fontWeight:"900",letterSpacing:.5},
 marketLabel:{color:"#087f72",fontSize:9,fontWeight:"900",letterSpacing:.7,marginTop:12},evidence:{color:"#4f6f7b",fontSize:12,lineHeight:19,marginTop:5},marketConfidence:{color:"#087f72",fontSize:11,fontWeight:"800",marginTop:9},
 action:{minHeight:62,borderTopWidth:1,borderTopColor:"#edf4f2",flexDirection:"row",alignItems:"center",gap:10},actionIcon:{width:36,height:36,borderRadius:11,backgroundColor:"#e8f7f4",alignItems:"center",justifyContent:"center"},actionTitle:{color:"#062f4f",fontSize:13,fontWeight:"900"},actionCopy:{color:"#66858d",fontSize:10,lineHeight:14,marginTop:2},disclaimer:{color:"#789097",fontSize:10,lineHeight:15,textAlign:"center",marginTop:15},center:{flex:1,alignItems:"center",justifyContent:"center",padding:30},loading:{color:"#66858d",fontSize:12,marginTop:10},missingTitle:{color:"#062f4f",fontSize:20,fontWeight:"900",marginTop:10},backButton:{marginTop:15,padding:12},backText:{color:"#087f72",fontWeight:"900"}
});
