   ...
   <KeyboardAvoidingView style={{flex:1}} behavior={Platform.OS==="ios"?"padding":undefined}>
    <ScrollView contentContainerStyle={s.page} keyboardShouldPersistTaps="handled">
     ...
     <View style={s.card}>
      ...
      <TextInput style={s.input} value={email} onChangeText={setEmail} placeholder="you@example.com" placeholderTextColor={DynamicColorIOS({light:"#789097",dark:"#c7d9da"})} autoCapitalize="none" autoCorrect={false} keyboardType="email-address" textContentType="emailAddress" editable={!authBusy}/>
      <Text style={s.inputLabel}>Password</Text>
      <TextInput style={s.input} value={password} onChangeText={setPassword} placeholder="Password" placeholderTextColor={DynamicColorIOS({light:"#789097",dark:"#c7d9da"})} secureTextEntry textContentType="password" editable={!authBusy} onSubmitEditing={signIn}/>
...
const s=StyleSheet.create({
 ...
 title:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:38,fontWeight:"900",marginTop:5},email:{color:DynamicColorIOS({light:"#66858d",dark:"#c7d9da"}),fontSize:14,marginTop:4,marginBottom:18},
 ...
 sectionTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:20,fontWeight:"900",marginBottom:4},copy:{color:DynamicColorIOS({light:"#5f7c86",dark:"#c7d9da"}),fontSize:14,lineHeight:21,marginTop:5},hint:{color:DynamicColorIOS({light:"#789097",dark:"#c7d9da"}),fontSize:12,lineHeight:18,marginTop:12},
 ...
 rowLabel:{color:"#4f6f7b",fontSize:14,fontWeight:"700"},rowValue:{color:DynamicColorIOS({light:"#173f51",dark:"#f5fffd"}),fontSize:13,fontWeight:"900",maxWidth:"45%",textAlign:"right"},
 ...
 plansButton:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderWidth:1.5,borderColor:"#8fd4c8",borderRadius:18,padding:14,marginBottom:12,flexDirection:"row",alignItems:"center",gap:11},plansIcon:{width:40,height:40,borderRadius:12,backgroundColor:DynamicColorIOS({light:"#e8f7f4",dark:"#17383d"}),alignItems:"center",justifyContent:"center"},plansTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:16,fontWeight:"900"},plansCopy:{color:DynamicColorIOS({light:"#66858d",dark:"#c7d9da"}),fontSize:12,marginTop:2},
 ...
 divider:{height:1,backgroundColor:DynamicColorIOS({light:"#edf4f2",dark:"#24464c"}),marginVertical:6},newHere:{color:DynamicColorIOS({light:"#66858d",dark:"#c7d9da"}),fontSize:13,textAlign:"center",marginTop:10},
