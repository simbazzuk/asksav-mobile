...
const s=StyleSheet.create({
 ...
 plusCard:{borderColor:DynamicColorIOS({light:"#8f7bd8",dark:"#a995f2"}),backgroundColor:DynamicColorIOS({light:"#f7f5ff",dark:"#1b2638"})},proCard:{borderColor:DynamicColorIOS({light:"#315a86",dark:"#6f9fd0"}),backgroundColor:DynamicColorIOS({light:"#f2f6fb",dark:"#14283b"})},
