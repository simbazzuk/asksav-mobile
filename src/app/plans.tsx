...
const s=StyleSheet.create({
 ...
 eyebrow:{color:"#0a9b80",fontSize:12,fontWeight:"900",letterSpacing:1.1},title:{color:DynamicColorIOS({light:"#062f4f",dark:"#eefbf8"}),fontSize:26,lineHeight:31,fontWeight:"900",marginTop:6},copy:{color:DynamicColorIOS({light:"#5f7c86",dark:"#9db7b9"}),fontSize:14,lineHeight:21,marginTop:8,marginBottom:18},
