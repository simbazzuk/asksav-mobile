...
import { Image, ActivityIndicator, Alert, KeyboardAvoidingView, Platform, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, DynamicColorIOS } from "react-native";
...
export default function AccountScreen(){
 ...
 if(!user) return <SafeAreaView style={s.safe}>
   <KeyboardAvoidingView style={{flex:1}} behavior={Platform.OS==="ios"?"padding":undefined}>
    <ScrollView contentContainerStyle={s.page} keyboardShouldPersistTaps="handled">
     <AskSAVPageHeader title="Account" description="Your plan, usage and AskSAV settings."/>
     <View style={s.card}>
      ...
      <TextInput style={s.input} value={email} onChangeText={setEmail} placeholder="you@example.com" placeholderTextColor={DynamicColorIOS({light:"#789097",dark:"#e0eeee"})} autoCapitalize="none" autoCorrect={false} keyboardType="email-address" textContentType="emailAddress" editable={!authBusy}/>
      <Text style={s.inputLabel}>Password</Text>
      <TextInput style={s.input} value={password} onChangeText={setPassword} placeholder="Password" placeholderTextColor={DynamicColorIOS({light:"#789097",dark:"#e0eeee"})} secureTextEntry textContentType="password" editable={!authBusy} onSubmitEditing={signIn}/>
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
   ...
   {error?<View style={s.error}><Text style={s.errorText}>Your account is signed in, but plan details could not be loaded. Try again shortly.</Text></View>:null}
   {!loading&&!error?<>
   ...
   {!loading&&!error&&state?<TouchableOpacity style={s.plansButton} onPress={()=>router.push({pathname:"/plans",params:{plan:String(state?.plan||"FREE")}})}>
...
const s=StyleSheet.create({
 ...
 title:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:38,fontWeight:"900",marginTop:5},email:{color:DynamicColorIOS({light:"#66858d",dark:"#d6e7e8"}),fontSize:14,marginTop:4,marginBottom:18},
 ...
 planCard:{backgroundColor:DynamicColorIOS({light:"#effaf6",dark:"#10282d"}),borderRadius:20,padding:19,borderWidth:2,borderColor:DynamicColorIOS({light:"#63c7ad",dark:"#72d8c0"}),flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginBottom:12},
 plusCard:{borderColor:DynamicColorIOS({light:"#8b73d9",dark:"#b9a4ff"}),backgroundColor:DynamicColorIOS({light:"#f7f4ff",dark:"#20263a"})},proCard:{borderColor:DynamicColorIOS({light:"#4f78a6",dark:"#82b6ea"}),backgroundColor:DynamicColorIOS({light:"#f2f7fc",dark:"#142a3c"})},
 planLabel:{color:"#087f72",fontSize:11,fontWeight:"900",letterSpacing:.8},planName:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:27,fontWeight:"900",marginTop:4},
 card:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderRadius:20,padding:18,borderWidth:1,borderColor:DynamicColorIOS({light:"#cfe8e2",dark:"#24464c"}),marginBottom:12},cardTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:21,fontWeight:"900",marginTop:10},
 sectionTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:20,fontWeight:"900",marginBottom:4},copy:{color:DynamicColorIOS({light:"#5f7c86",dark:"#d6e7e8"}),fontSize:14,lineHeight:21,marginTop:5},hint:{color:DynamicColorIOS({light:"#789097",dark:"#e0eeee"}),fontSize:12,lineHeight:18,marginTop:12},
 ...
 rowLabel:{color:DynamicColorIOS({light:"#4f6f7b",dark:"#d6e7e8"}),fontSize:14,fontWeight:"700"},rowValue:{color:DynamicColorIOS({light:"#173f51",dark:"#f5fffd"}),fontSize:13,fontWeight:"900",maxWidth:"45%",textAlign:"right"},
 upgrade:{backgroundColor:"#eef9ff",borderWidth:1,borderColor:"#bedce9",borderRadius:20,padding:18,marginBottom:12},upgradeTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:17,fontWeight:"900"},
 ...
 plansButton:{backgroundColor:DynamicColorIOS({light:"#fff",dark:"#10282d"}),borderWidth:1.5,borderColor:"#8fd4c8",borderRadius:18,padding:14,marginBottom:12,flexDirection:"row",alignItems:"center",gap:11},plansIcon:{width:40,height:40,borderRadius:12,backgroundColor:DynamicColorIOS({light:"#e8f7f4",dark:"#17383d"}),alignItems:"center",justifyContent:"center"},plansTitle:{color:DynamicColorIOS({light:"#062f4f",dark:"#f5fffd"}),fontSize:16,fontWeight:"900"},plansCopy:{color:DynamicColorIOS({light:"#66858d",dark:"#d6e7e8"}),fontSize:12,marginTop:2},
 signout:{minHeight:52,borderRadius:16,borderWidth:1,borderColor:"#efcabb",backgroundColor:DynamicColorIOS({light:"#fff8f5",dark:"#351d19"}),flexDirection:"row",gap:8,alignItems:"center",justifyContent:"center",marginTop:4},signoutText:{color:DynamicColorIOS({light:"#8a4933",dark:"#ffc1ad"}),fontWeight:"900"},
 inputLabel:{color:DynamicColorIOS({light:"#173f51",dark:"#f5fffd"}),fontSize:13,fontWeight:"800",marginTop:15,marginBottom:6},
 input:{minHeight:52,borderWidth:1,borderColor:DynamicColorIOS({light:"#cfe8e2",dark:"#24464c"}),borderRadius:14,backgroundColor:DynamicColorIOS({light:"#f8fcfb",dark:"#10282d"}),paddingHorizontal:14,color:DynamicColorIOS({light:"#173f51",dark:"#f5fffd"}),fontSize:15},
 ...
 divider:{height:1,backgroundColor:DynamicColorIOS({light:"#edf4f2",dark:"#24464c"}),marginVertical:6},newHere:{color:DynamicColorIOS({light:"#66858d",dark:"#d6e7e8"}),fontSize:13,textAlign:"center",marginTop:10},
 ...
 authError:{backgroundColor:DynamicColorIOS({light:"#fff7f3",dark:"#351d19"}),borderWidth:1,borderColor:"#f0c9b8",borderRadius:12,padding:11,marginTop:12},authErrorText:{color:DynamicColorIOS({light:"#8a4933",dark:"#ffc1ad"}),fontSize:12,lineHeight:18,fontWeight:"700"},
 error:{backgroundColor:DynamicColorIOS({light:"#fff7f3",dark:"#351d19"}),borderWidth:1,borderColor:"#f0c9b8",borderRadius:16,padding:14,marginBottom:12},errorText:{color:DynamicColorIOS({light:"#8a4933",dark:"#ffc1ad"}),fontSize:13,fontWeight:"700"}
});